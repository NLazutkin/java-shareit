...
public class ItemJsonTest {
    ...
    void testResponseDto() throws Exception {
        ...
        assertThat(result).extractingJsonPathStringValue("$.lastBooking").isEqualTo(responseDto.getLastBooking()
                .format(DateTimeFormatter.ofPattern("yyyy-MM-dd'T'HH:mm:ss.SSSSSSS")));
        assertThat(result).extractingJsonPathStringValue("$.nextBooking").isEqualTo(responseDto.getNextBooking()
                .format(DateTimeFormatter.ofPattern("yyyy-MM-dd'T'HH:mm:ss.SSSSSSS")));
